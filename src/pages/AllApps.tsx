...
const CATEGORIES: Category[] = [
  {
    ...
    apps: [
      ...
      { name: "Fòrum", desc: "Gestiona un fòrum de preguntes freqüents", icon: "💬", img: "/app-icons/forum.svg" },
      { name: "eLearning", desc: "Gestiona i publica els teus cursos", icon: "🎓", img: "/app-icons/elearning.svg" },
  ...
  },
  {
    ...
    apps: [
      ...
      { name: "Signatura electrònica", desc: "Signa documents en línia", icon: "✍️", img: "/app-icons/signatura-electronica.svg" },
    ],
  },
  {
  ...
  },
  {
    ...
    apps: [
      { name: "Empleats", desc: "Centralitza la informació dels teus empleats", icon: "👥", img: "/app-icons/empleats.svg" },
      ...
      { name: "Avaluacions", desc: "Avalua els teus empleats", icon: "⭐", img: "/app-icons/avaluacions.svg" },
