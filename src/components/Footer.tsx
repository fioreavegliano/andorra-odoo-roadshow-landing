        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Partner oficial de Odoo en Andorra. Especialistas en
              implementación y desarrollo de soluciones ERP para empresas
              andorranas.
            </p>
          ...
          {/*<div>
            ...
            <p className="text-gray-400 mb-4">
              Suscríbete para recibir información sobre eventos y novedades de
              Odoo.
            </p>
            <div className="flex">
              <input
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © {new Date().getFullYear()} BDR Informatica. Todos los derechos
              reservados.
            </p>
